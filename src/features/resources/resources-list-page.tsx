...
export function ResourcesListPage() {
  ...
  const all = useMemo(() => resourcesQuery.data ?? [], [resourcesQuery.data]);
            ...
            <tbody>
              {filtered.map((r) => (
                ...
                >
                  ...
                  <td className="px-3 py-2.5 capitalize text-fg-muted">{r.type}</td>
                  <td className="px-3 py-2.5 text-fg-muted">{r.owner ?? "—"}</td>
